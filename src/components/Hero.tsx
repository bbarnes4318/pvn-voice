...
export const HeroTop: React.FC = () => {
  return (
    <section
      id="pvn-hero"
      className="relative bg-gradient-to-br from-navy-900 to-navy-700 text-white"
      style={{ marginTop: 'calc(var(--pvn-header-h, 128px) * -1)', paddingTop: 'var(--pvn-header-h, 128px)' }}
    >
      ...
      <div className="container-custom relative z-10">
        <div className="py-16 md:py-24 lg:py-28 max-w-4xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Next-Generation VoIP &amp; Dialers for Growth
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            ...
            <div className="flex items-center space-x-3">
              <FaChartLine className="text-green-500 text-xl flex-shrink-0" />
            ...
            <div className="flex items-center space-x-3">
              <FaHeadset className="text-green-500 text-xl flex-shrink-0" />
              <span>Receive Dedicated 24/7 Expert Support</span>
            </div>
            <div className="flex items-center space-x-3">
              <FaClock className="text-green-500 text-xl flex-shrink-0" />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a 
              href="/contact-us" 
              className="btn-call flex items-center justify-center space-x-3 bg-white text-navy-500 hover:bg-navy-50"
            >
      ...
      <div className="bg-white bg-opacity-5 py-12">
        <div className="container-custom">
          <div className="text-center mb-12">
            ...
            <p className="text-lg max-w-3xl mx-auto text-navy-50">
          ...
          <div className="bg-white bg-opacity-5 p-6 rounded-lg mb-12">
            ...
            <p className="text-center text-navy-50 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
              <div className="bg-white bg-opacity-10 p-5 rounded-lg text-center hover:bg-opacity-15 transition-all">
                <FaRocket className="text-green-500 text-3xl mx-auto mb-3" />
                <h4 className="font-bold mb-2">Predictive Dialer</h4>
                <p className="text-sm text-navy-200">Intelligent call pacing that boosts agent productivity by up to 300%</p>
              </div>
              
              <div className="bg-white bg-opacity-10 p-5 rounded-lg text-center hover:bg-opacity-15 transition-all">
                <FaCloudUploadAlt className="text-green-500 text-3xl mx-auto mb-3" />
                <h4 className="font-bold mb-2">Cloud PBX</h4>
                <p className="text-sm text-navy-200">Complete business phone system with advanced call management features</p>
              </div>
              
              <div className="bg-white bg-opacity-10 p-5 rounded-lg text-center hover:bg-opacity-15 transition-all">
                <FaPhoneAlt className="text-green-500 text-3xl mx-auto mb-3" />
                <h4 className="font-bold mb-2">Auto Dialer</h4>
                <p className="text-sm text-navy-200">Automated outbound calling with customizable campaigns and analytics</p>
              </div>
              
              <div className="bg-white bg-opacity-10 p-5 rounded-lg text-center hover:bg-opacity-15 transition-all">
                <FaMicrophone className="text-green-500 text-3xl mx-auto mb-3" />
                <h4 className="font-bold mb-2">VoIP Phone Service</h4>
                <p className="text-sm text-navy-200">Crystal-clear voice quality with 99.99% uptime guarantee</p>
              </div>
              
              <div className="bg-white bg-opacity-10 p-5 rounded-lg text-center hover:bg-opacity-15 transition-all">
                <FaExchangeAlt className="text-green-500 text-3xl mx-auto mb-3" />
                <h4 className="font-bold mb-2">SIP Trunking</h4>
                <p className="text-sm text-navy-200">Cost-effective, flexible phone line replacement for existing systems</p>
              </div>
            </div>
          </div>
        </div>
