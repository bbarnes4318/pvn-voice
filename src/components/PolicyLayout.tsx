...
const PolicyLayout: React.FC<PolicyLayoutProps> = ({
  ...
  return (
    <div className="policy-page min-h-screen flex flex-col bg-gradient-to-br from-navy-50 to-navy-100">
      <Head>
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="policy-hero bg-navy-500 text-white py-10">
          <div className="container-custom">
            <div className="max-w-3xl mx-auto">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  onClick={handlePrint}
                  className="no-print text-navy-50 hover:text-white transition-colors text-sm flex items-center"
                >
                ...
                <div className="sticky top-8">
                  ...
                  <div className="mt-6 bg-navy-50 p-5 rounded-lg border border-navy-100">
                    <div className="flex items-center mb-3">
                      <FaPhoneAlt className="text-navy-500 mr-2" />
                      <h3 className="font-bold text-navy-600">Do-Not-Call Requests</h3>
                    </div>
              ...
              <div className="policy-body lg:w-3/4">
                ...
                >
                  <div className="flex items-start">
                    <IntroIcon className="text-navy-500 text-2xl mr-4 mt-1 flex-shrink-0" />
                    <div>
                ...
                <div className="prose prose-sm max-w-none">
                  ...
                  <p className="text-gray-600 text-sm italic mt-8 pt-6 border-t border-gray-200">
                    This policy is reviewed at least annually and upon any material change in applicable law. A copy of this policy is available on request at <a href={DNC_PHONE_HREF} className="text-navy-500 hover:text-navy-600">{DNC_PHONE_DISPLAY}</a>.
                  </p>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {relatedPolicies.map((policy) => (
                      <Link
                        key={policy.href}
                        href={policy.href}
                        className="bg-white border border-gray-200 rounded-md p-3 shadow-sm hover:shadow transition-shadow text-sm font-medium text-navy-500 hover:text-navy-600"
                      >
                        {policy.name}
                      </Link>
                    ))}
