        ...
        <section className="py-10 bg-white">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center mb-3">
                        <PolicyIcon className="text-navy-500 text-xl mr-3 flex-shrink-0" />
                        <h2 className="text-lg font-bold text-gray-800">{policy.name}</h2>
                      </div>
                      <p className="text-gray-600 text-sm leading-relaxed flex-grow">
                        {policy.description}
                      </p>
                      <span className="text-navy-500 hover:text-navy-600 text-sm font-medium mt-4">
              ...
              <div className="mt-10 bg-navy-50 p-6 rounded-lg border border-navy-100">
                <div className="flex items-start">
                  <FaPhoneAlt className="text-navy-500 text-xl mr-4 mt-1 flex-shrink-0" />
                  <div>
                    <h2 className="text-lg font-bold text-navy-600 mb-2">Do-Not-Call Requests and Policy Copies</h2>
                    ...
                    <a
                      href={DNC_PHONE_HREF}
                      className="inline-block bg-navy-500 hover:bg-navy-600 text-white text-center py-2 px-6 rounded text-sm font-medium"
                    >
              ...
              <p className="text-gray-600 text-sm italic mt-8 pt-6 border-t border-gray-200">
                These policies are reviewed at least annually and upon any material change in applicable law. Copies are available on request at <a href={DNC_PHONE_HREF} className="text-navy-500 hover:text-navy-600">{DNC_PHONE_DISPLAY}</a>.
              </p>
            </div>
          </div>
        </section>
