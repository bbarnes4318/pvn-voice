  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-navy-50 to-navy-100">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-navy-600 to-navy-900 text-white py-20 overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-2xl md:text-3xl text-navy-50 mb-8 font-medium drop-shadow">Effortless customer experiences. Empowered agents. Limitless scalability.</p>
              <a 
                href="tel:+19045128487" 
                className="inline-block bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg transition-colors">
        ...
        {/* Core Features */}
        <section className="py-16 bg-gradient-to-br from-white to-navy-50">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Core Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              <div className="bg-gradient-to-br from-purple-100 to-purple-50 p-8 rounded-2xl shadow-lg flex flex-col items-center text-center">
                <FaMicrophone className="text-4xl text-navy-500 mb-4" />
        ...
        <section className="py-16 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Business Benefits</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-white p-8 rounded-2xl shadow flex flex-col items-center text-center border border-navy-100">
              ...
              <div className="bg-white p-8 rounded-2xl shadow flex flex-col items-center text-center border border-navy-100">
                <FaUserTie className="text-3xl text-navy-500 mb-4" />
              ...
              <div className="bg-white p-8 rounded-2xl shadow flex flex-col items-center text-center border border-navy-100">
                <FaHandshake className="text-3xl text-navy-500 mb-4" />
        ...
        <section className="py-16 bg-gradient-to-br from-white to-navy-50">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Perfect for Your Industry</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="bg-gradient-to-br from-navy-50 to-navy-100 p-8 rounded-2xl shadow flex flex-col items-center text-center">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-navy-600 to-navy-400 text-white">
          <div className="container-custom">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-4xl font-bold mb-6 drop-shadow">Ready to Transform Your Contact Center?</h2>
              <p className="text-2xl text-navy-50 mb-8 font-medium drop-shadow">Contact us today to learn how our cloud contact center solution can help you deliver exceptional customer experiences.</p>
              <a 
                href="tel:+19045128487" 
