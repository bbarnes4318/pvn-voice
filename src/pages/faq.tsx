            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-gray-50 p-6 rounded-xl">
                  <FaPhoneAlt className="text-3xl text-navy-500 mb-4 mx-auto" />
                  <h3 className="text-xl font-semibold mb-2">Phone Support</h3>
                  <p className="text-gray-600 mb-4">24/7 phone support for immediate assistance</p>
                  <a 
                    href="tel:+19045128487" 
                    className="text-navy-500 hover:text-navy-600 font-medium"
                  >
                    Call (904) 512-8487
                  </a>
                </div>
                <div className="bg-gray-50 p-6 rounded-xl">
                  <FaEnvelope className="text-3xl text-navy-500 mb-4 mx-auto" />
