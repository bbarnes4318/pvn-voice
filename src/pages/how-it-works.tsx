    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-navy-50 to-navy-100">
      ...
      <main className="flex-grow">
              ...
              <div className="space-y-16">
                ...
                <div className="grid md:grid-cols-5 gap-8 items-center">
                  <div className="md:col-span-2">
                    <div className="bg-navy-50 p-8 rounded-xl relative">
                      <div className="absolute -top-5 -left-5 w-12 h-12 bg-navy-500 text-white rounded-full flex items-center justify-center text-xl font-bold">
                        1
                      </div>
                      <FaUserFriends className="text-5xl text-navy-500 mb-4" />
                      <h2 className="text-2xl font-bold text-navy-700 mb-3">Free Consultation</h2>
                  ...
                  <div className="md:col-span-3">
                    <h3 className="text-xl font-semibold text-navy-500 mb-3">What happens in this step:</h3>
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <FaCheckCircle className="text-green-700 mt-1 mr-2 flex-shrink-0" />
                ...
                <div className="grid md:grid-cols-5 gap-8 items-center">
                  <div className="md:col-span-2 md:order-2">
                    <div className="bg-navy-50 p-8 rounded-xl relative">
                      ...
                      <FaClock className="text-5xl text-navy-500 mb-4" />
                      <h2 className="text-2xl font-bold text-navy-700 mb-3">Enrollment & Savings</h2>
                      <p className="text-gray-700">
                ...
                <div className="grid md:grid-cols-5 gap-8 items-center">
                  <div className="md:col-span-2">
                    <div className="bg-navy-50 p-8 rounded-xl relative">
                      ...
                      <FaComments className="text-5xl text-navy-500 mb-4" />
                      <h2 className="text-2xl font-bold text-navy-700 mb-3">Debt Negotiation</h2>
                      <p className="text-gray-700">
                ...
                <div className="grid md:grid-cols-5 gap-8 items-center">
                  <div className="md:col-span-2 md:order-2">
                    <div className="bg-navy-50 p-8 rounded-xl relative">
                      ...
                      <FaHandshake className="text-5xl text-navy-500 mb-4" />
                      <h2 className="text-2xl font-bold text-navy-700 mb-3">Freedom from Debt</h2>
                      <p className="text-gray-700">
        ...
        <section className="py-16 bg-gray-50">
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-center mb-12 text-navy-500">What to Expect: Program Timeline</h2>
              
              <div className="relative">
                {/* Timeline line */}
                <div className="hidden md:block absolute left-1/2 top-0 bottom-0 w-1 bg-navy-200 transform -translate-x-1/2 z-0"></div>
                
                <div className="space-y-12">
                  {/* Month 1 */}
                  <div className="relative flex flex-col md:flex-row items-center md:justify-between">
                    <div className="hidden md:flex absolute left-1/2 top-6 w-6 h-6 rounded-full bg-navy-500 transform -translate-x-1/2 z-10"></div>
                    <div className="md:w-5/12 mb-4 md:mb-0 md:pr-8">
                      <div className="bg-white p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-bold text-navy-500 mb-2">Months 1-3</h3>
                    ...
                    <div className="md:hidden w-6 h-6 rounded-full bg-navy-500 my-2"></div>
                  ...
                  <div className="relative flex flex-col md:flex-row-reverse items-center md:justify-between">
                    ...
                    <div className="md:w-5/12 mb-4 md:mb-0 md:pl-8">
                      <div className="bg-white p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-bold text-navy-500 mb-2">Months 4-6</h3>
                  ...
                  <div className="relative flex flex-col md:flex-row items-center md:justify-between">
                    ...
                    <div className="md:w-5/12 mb-4 md:mb-0 md:pr-8">
                      <div className="bg-white p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-bold text-navy-500 mb-2">Months 6-12</h3>
                  ...
                  <div className="relative flex flex-col md:flex-row-reverse items-center md:justify-between">
                    ...
                    <div className="md:w-5/12 mb-4 md:mb-0 md:pl-8">
                      <div className="bg-white p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-bold text-navy-500 mb-2">Months 12-24</h3>
                  ...
                  <div className="relative flex flex-col md:flex-row items-center md:justify-between">
                    ...
                    <div className="md:w-5/12 mb-4 md:mb-0 md:pr-8">
                      <div className="bg-white p-6 rounded-xl shadow-md">
                        <h3 className="text-xl font-bold text-navy-500 mb-2">Months 24-36</h3>
                  ...
                  {/* Program Completion */}
                  <div className="relative flex flex-col md:flex-row-reverse items-center md:justify-between">
                    <div className="hidden md:flex absolute left-1/2 top-6 w-8 h-8 rounded-full bg-green-700 transform -translate-x-1/2 z-10 flex items-center justify-center">
                      <FaCheckCircle className="text-white" />
                    </div>
                    <div className="md:w-5/12 mb-4 md:mb-0 md:pl-8">
                      <div className="bg-green-50 p-6 rounded-xl shadow-md border-2 border-green-500">
                        <h3 className="text-xl font-bold text-green-800 mb-2">Program Completion</h3>
                    ...
                    <div className="md:hidden w-8 h-8 rounded-full bg-green-700 my-2 flex items-center justify-center">
                      <FaCheckCircle className="text-white" />
                    </div>
                    <div className="md:w-5/12 md:pr-8">
                      <div className="bg-white p-4 rounded-lg border border-gray-200 text-sm text-gray-600">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-navy-500 mb-2">Who qualifies for debt settlement?</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-navy-500 mb-2">How much does debt settlement cost?</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-navy-500 mb-2">Will debt settlement affect my credit score?</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-navy-500 mb-2">Can creditors sue me during debt settlement?</h3>
                  <p className="text-gray-700">
                ...
                <div className="bg-gray-50 p-6 rounded-xl">
                  <h3 className="text-xl font-bold text-navy-500 mb-2">Are there tax consequences to debt settlement?</h3>
                  <p className="text-gray-700">
              ...
              <div className="text-center mt-12">
                <Link href="/faq" className="text-green-700 font-semibold hover:text-green-800 flex items-center justify-center">
