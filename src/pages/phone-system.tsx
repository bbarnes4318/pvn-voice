      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-r from-navy-600 to-navy-400 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-2xl md:text-3xl mb-8 font-medium text-navy-50 drop-shadow">All the advanced features of an enterprise phone system—none of the hardware or hassle.</p>
            <a href="/pricing" className="inline-flex items-center space-x-3 bg-green-700 hover:bg-green-800 text-white px-10 py-5 rounded-xl font-bold text-xl shadow-cta transition-colors">See Plans & Pricing</a>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Everything You Need in a Modern Phone System</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaCogs className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Auto-Attendant & IVR</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaMobileAlt className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Mobile & Desktop Apps</h3>
                <p className="text-gray-700 text-center">Make and receive business calls from any device, anywhere.</p>
              </div>
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaChartPie className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Call Analytics & Reports</h3>
                <p className="text-gray-700 text-center">Gain insights into call volumes, peak times, and team performance.</p>
              </div>
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaCloud className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Cloud-Based Reliability</h3>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom flex flex-col md:flex-row items-center gap-12 max-w-6xl mx-auto">
            ...
            <div className="flex-1">
              <h2 className="text-3xl font-bold text-navy-600 mb-6">Why Choose PVN Voice?</h2>
              ...
              <a href="/contact-us" className="mt-8 inline-flex items-center space-x-3 bg-green-700 hover:bg-green-800 text-white px-10 py-5 rounded-xl font-bold text-xl shadow-cta transition-colors">Get a Custom Quote</a>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">How PVN Voice Works: Simple, Reliable, Powerful</h2>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <span className="text-3xl font-bold text-navy-600 mb-2">1</span>
                <h3 className="text-lg font-bold text-navy-600 mb-2">Sign Up & Configure</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <span className="text-3xl font-bold text-navy-600 mb-2">2</span>
                <h3 className="text-lg font-bold text-navy-600 mb-2">Set Up Your Team</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <span className="text-3xl font-bold text-navy-600 mb-2">3</span>
                <h3 className="text-lg font-bold text-navy-600 mb-2">Connect Your Devices</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <span className="text-3xl font-bold text-navy-600 mb-2">4</span>
                <h3 className="text-lg font-bold text-navy-600 mb-2">Start Communicating</h3>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Perfect for the Way Modern Businesses Work</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaBuilding className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Remote & Hybrid Teams</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                ...
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Multiple Locations</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaHeadset className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Customer Service Teams</h3>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">What Our Customers Say</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {testimonials.map((t, idx) => (
                <div key={idx} className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                  <FaQuoteLeft className="text-3xl text-navy-500 mb-4" />
                  <p className="text-lg text-navy-700 italic mb-4">“{t.quote}”</p>
                  <span className="font-bold text-navy-600">{t.name}</span>
                  <span className="text-navy-500 text-sm">{t.title}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-r from-navy-600 to-navy-400 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-navy-50">Join thousands of businesses that trust PVN Voice for reliable, feature-rich communications.</p>
            <a 
