      ...
      <main className="flex-grow">
        ...
        <section className="bg-gradient-to-r from-navy-600 to-navy-400 text-white py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-2xl md:text-3xl mb-8 font-medium text-navy-50 drop-shadow">Comprehensive VOIP and Dialer Services</p>
            <p className="text-lg mb-8 text-navy-50">Cutting-edge VOIP systems and intelligent Dialer solutions engineered to empower your agents, streamline global operations, and drive unparalleled efficiency and customer satisfaction.</p>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-8 text-navy-600">Advanced VOIP Solutions</h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaGlobe className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Crystal-Clear Global Communication</h3>
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaUsers className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Intelligent Call Management</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
        ...
        <section className="py-16 bg-gray-50">
          <div className="max-w-5xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-navy-600">Actionable Insights & Seamless Workflow Integration</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-8 rounded-2xl shadow-lg flex flex-col items-center text-center">
                <FaChartBar className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Turn Data Into Strategy</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
              ...
              <div className="bg-white p-8 rounded-2xl shadow flex flex-col justify-center text-center border border-navy-100">
                <ul className="space-y-4 text-gray-700 mb-4">
                  <li className="flex items-start"><FaFileAlt className="text-navy-500 mt-1 mr-3" /><span><b>Comprehensive Call Recording:</b> Capture all calls for quality assurance, training, compliance, and dispute resolution.</span></li>
                  <li className="flex items-start"><FaChartBar className="text-navy-500 mt-1 mr-3" /><span><b>Real-Time Analytics & Reporting:</b> Dashboards and reports on key metrics like AHT, FCR, call volume, and agent performance.</span></li>
                  <li className="flex items-start"><FaPlug className="text-navy-500 mt-1 mr-3" /><span><b>CRM & Business Tool Integration:</b> Integrate with Salesforce, HubSpot, Zendesk, and more for streamlined workflows.</span></li>
                  <li className="flex items-start"><FaRobot className="text-navy-500 mt-1 mr-3" /><span><b>AI-Powered Insights:</b> AI call summaries, sentiment analysis, and conversation intelligence for coaching and optimization.</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-green-50 to-green-100">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-8 text-green-800">High-Performance Dialer Systems</h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-green-100">
                <FaSync className="text-4xl text-green-700 mb-4" />
                <h3 className="text-2xl font-bold text-green-800 mb-4">Smart Dialing Modes</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
              ...
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-green-100">
                <FaUserTie className="text-4xl text-green-700 mb-4" />
                <h3 className="text-2xl font-bold text-green-800 mb-4">Personalized Outreach</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
        ...
        <section className="py-16 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="max-w-5xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-navy-600">Ensuring Compliance & Operational Efficiency</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="border-l-8 border-navy-500 bg-white p-8 rounded-2xl shadow-lg flex flex-col items-center text-center">
                <FaShieldAlt className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Compliance & Efficiency</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
              ...
              <div className="bg-white p-8 rounded-2xl shadow flex flex-col justify-center text-center border border-navy-100">
                <ul className="space-y-4 text-gray-700 mb-4">
                  <li className="flex items-start"><FaMicrophone className="text-navy-500 mt-1 mr-3" /><span><b>Answering Machine Detection (AMD):</b> Intelligently identifies answering machines and voicemails, saving agent time.</span></li>
                  <li className="flex items-start"><FaEnvelope className="text-navy-500 mt-1 mr-3" /><span><b>Automated Voicemail Drop:</b> Agents leave a pre-recorded voicemail with a single click.</span></li>
                  <li className="flex items-start"><FaLock className="text-navy-500 mt-1 mr-3" /><span><b>DNC List Management & TCPA Compliance:</b> Automatically scrub against Do Not Call lists and manage consent for compliance.</span></li>
                  <li className="flex items-start"><FaShieldAlt className="text-navy-500 mt-1 mr-3" /><span><b>Caller ID Reputation Management:</b> Protect your outbound caller IDs from being flagged as spam.</span></li>
                  <li className="flex items-start"><FaChartBar className="text-navy-500 mt-1 mr-3" /><span><b>Campaign Management & Real-Time Analytics:</b> Set up, manage, and monitor campaigns with real-time metrics.</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-100 to-navy-200">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-8 text-navy-600">AI-Powered Enhancements</h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-200">
                <FaRobot className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Smarter Conversations</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
              ...
              <div className="bg-gradient-to-br from-navy-200 to-navy-100 p-10 rounded-2xl shadow-lg flex flex-col items-center text-center">
                <h3 className="text-2xl font-bold text-navy-600 mb-4">AI in Every Interaction</h3>
        ...
        <section className="py-16 bg-gradient-to-br from-green-50 to-green-100">
          <div className="max-w-5xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8 text-green-800">Seamless Integration & Tailored Customization</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-green-100 to-green-50 p-8 rounded-2xl shadow-lg flex flex-col items-center text-center">
                <FaPlug className="text-4xl text-green-700 mb-4" />
                <h3 className="text-2xl font-bold text-green-800 mb-4">Flexible Integration & Customization</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
              ...
              <div className="bg-white p-8 rounded-2xl shadow flex flex-col justify-center text-center border border-green-100">
                <ul className="space-y-4 text-gray-700 mb-4">
                  <li className="flex items-start"><FaPlug className="text-green-700 mt-1 mr-3" /><span><b>Integration Capabilities:</b> Robust APIs and pre-built integrations with leading CRM, helpdesk, and third-party applications.</span></li>
                  <li className="flex items-start"><FaCog className="text-green-700 mt-1 mr-3" /><span><b>Customizable Solutions:</b> Tailored packages for small, growing call centers or large, multi-site enterprises.</span></li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-4xl font-bold text-center mb-8 text-navy-600">Why Partner With Us?</h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div className="bg-white p-10 rounded-2xl shadow-lg flex flex-col items-center text-center border border-navy-100">
                <FaHandshake className="text-4xl text-navy-500 mb-4" />
                <h3 className="text-2xl font-bold text-navy-600 mb-4">Your Strategic Ally</h3>
                <ul className="space-y-3 text-lg text-gray-700 mb-4 text-left max-w-md mx-auto">
              ...
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-10 rounded-2xl shadow-lg flex flex-col items-center text-center">
                <h3 className="text-2xl font-bold text-navy-600 mb-4">More Than a Vendor</h3>
        ...
        <section className="py-20 bg-gradient-to-r from-navy-600 to-navy-400 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-navy-50">Discover how our intelligent VOIP and Dialer services can revolutionize your call center's performance, enhance customer engagement, and drive sustainable growth.</p>
            <a href="tel:+19045128487" className="inline-flex items-center space-x-3 bg-green-700 hover:bg-green-800 text-white px-10 py-5 rounded-xl font-bold text-xl shadow-cta transition-colors">
              <FaPhoneAlt className="text-white text-2xl" />
