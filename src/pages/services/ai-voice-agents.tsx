  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-navy-700 to-navy-900 text-white py-20 overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-2xl md:text-3xl text-navy-50 mb-8 font-medium drop-shadow">Conversational AI that sounds human, works 24/7, and scales with your business.</p>
              <a href="tel:+19045128487" className="inline-block bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-lg transition-colors">
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">AI Voicebot Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaRobot className="text-4xl text-navy-500 mb-4" aria-label="Natural Language Understanding" />
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaMicrochip className="text-4xl text-navy-500 mb-4" aria-label="Real-Time Speech Synthesis" />
              ...
              <div className="bg-gradient-to-br from-yellow-100 to-yellow-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaHeadset className="text-4xl text-navy-500 mb-4" aria-label="24/7 Availability" />
              ...
              <div className="bg-gradient-to-br from-purple-100 to-purple-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaCloud className="text-4xl text-navy-500 mb-4" aria-label="Cloud Scalability" />
              ...
              <div className="bg-gradient-to-br from-pink-100 to-pink-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaChartLine className="text-4xl text-navy-500 mb-4" aria-label="Analytics & Insights" />
              ...
              <div className="bg-gradient-to-br from-gray-100 to-gray-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaCheck className="text-4xl text-navy-500 mb-4" aria-label="Seamless Integration" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              {voiceSamples.map((sample, idx) => (
                <div key={idx} className="bg-white p-8 rounded-2xl shadow flex flex-col items-center">
                  <FaVolumeUp className="text-3xl text-navy-500 mb-4" />
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-navy-50 p-8 rounded-2xl shadow">
                <FaRobot className="text-3xl text-navy-500 mb-4" aria-label="Sales & Lead Gen" />
              ...
              <div className="bg-green-50 p-8 rounded-2xl shadow">
                <FaHeadset className="text-3xl text-navy-500 mb-4" aria-label="Customer Support" />
              ...
              <div className="bg-purple-50 p-8 rounded-2xl shadow">
                <FaUsers className="text-3xl text-navy-500 mb-4" aria-label="Reminders & Notifications" />
        ...
        <section className="py-20 bg-white">
          <div className="container-custom text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 mb-8">
              <a href="tel:+19045128487" className="inline-flex items-center px-8 py-4 rounded-full bg-green-700 hover:bg-green-800 text-lg font-semibold shadow-lg transition space-x-3">
            ...
            <a href="mailto:info@pvndialer.com" className="inline-flex items-center px-6 py-3 rounded-full bg-navy-500 hover:bg-navy-600 text-white font-semibold shadow transition space-x-2">
              <FaPhoneAlt />
              <span>Email Us</span>
            </a>
          </div>
