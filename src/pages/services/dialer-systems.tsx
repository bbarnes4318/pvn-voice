      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-gradient-to-br from-navy-600 to-navy-900 text-white py-20 overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-2xl md:text-3xl text-navy-50 mb-8 font-medium drop-shadow">Automate, accelerate, and optimize your outbound calling with next-generation dialer technology.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Advanced Dialer Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaRobot className="text-4xl text-navy-500 mb-4" aria-label="Auto Dialer" />
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaRocket className="text-4xl text-navy-500 mb-4" aria-label="Predictive Dialer" />
              ...
              <div className="bg-gradient-to-br from-yellow-100 to-yellow-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaCogs className="text-4xl text-navy-500 mb-4" aria-label="Power & Progressive Dialer" />
              ...
              <div className="bg-gradient-to-br from-purple-100 to-purple-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaCloud className="text-4xl text-navy-500 mb-4" aria-label="Cloud-Based Platform" />
              ...
              <div className="bg-gradient-to-br from-gray-100 to-gray-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaCheck className="text-4xl text-navy-500 mb-4" aria-label="Compliance Tools" />
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-navy-50 p-8 rounded-2xl shadow">
                <FaRobot className="text-3xl text-navy-500 mb-4" aria-label="Sales Teams" />
              ...
              <div className="bg-green-50 p-8 rounded-2xl shadow">
                <FaHeadset className="text-3xl text-navy-500 mb-4" aria-label="Support & Service" />
              ...
              <div className="bg-purple-50 p-8 rounded-2xl shadow">
                <FaUsers className="text-3xl text-navy-500 mb-4" aria-label="Collections & Billing" />
