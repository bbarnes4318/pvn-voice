      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-gradient-to-br from-navy-600 to-navy-900 text-white py-20 overflow-hidden">
          ...
          <div className="container-custom relative z-10">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-2xl md:text-3xl text-navy-50 mb-8 font-medium drop-shadow">Empower your call center with cloud-based VoIP solutions for superior customer service and agent performance.</p>
        ...
        <section className="py-20 bg-white">
          <div className="container-custom">
            <h2 className="text-4xl font-bold text-center mb-12 text-navy-600">Cloud Call Center Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaHeadset className="text-4xl text-navy-500 mb-4" aria-label="Omnichannel Support" />
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaChartLine className="text-4xl text-navy-500 mb-4" aria-label="Real-Time Analytics" />
              ...
              <div className="bg-gradient-to-br from-yellow-100 to-yellow-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaUsers className="text-4xl text-navy-500 mb-4" aria-label="Intelligent Call Routing" />
              ...
              <div className="bg-gradient-to-br from-purple-100 to-purple-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaCloud className="text-4xl text-navy-500 mb-4" aria-label="100% Cloud-Based" />
              ...
              <div className="bg-gradient-to-br from-pink-100 to-pink-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaRocket className="text-4xl text-navy-500 mb-4" aria-label="Auto Dialer & Power Dialer" />
          ...
          <div className="container-custom">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-navy-50 p-8 rounded-2xl shadow">
                <FaHeadset className="text-3xl text-navy-500 mb-4" aria-label="Inbound Call Centers" />
              ...
              <div className="bg-green-50 p-8 rounded-2xl shadow">
                <FaRocket className="text-3xl text-navy-500 mb-4" aria-label="Outbound Call Centers" />
              ...
              <div className="bg-purple-50 p-8 rounded-2xl shadow">
                <FaUsers className="text-3xl text-navy-500 mb-4" aria-label="Blended Call Centers" />
