            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                  <div className="text-green-700 text-2xl mb-2">1</div>
                  <p className="text-gray-700 font-medium">Use a wired connection</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                  <div className="text-green-700 text-2xl mb-2">2</div>
                  <p className="text-gray-700 font-medium">Enable QoS on your router</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                  <div className="text-green-700 text-2xl mb-2">3</div>
                  <p className="text-gray-700 font-medium">Use quality headsets</p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm text-center">
                  <div className="text-green-700 text-2xl mb-2">4</div>
              ...
              <div className="text-center mt-8">
                <Link href="/debt-calculator" className="inline-flex items-center text-green-700 hover:text-green-800 font-medium">
          ...
          <div className="container-custom">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mb-16">
                <div className="flex items-center mb-6">
                  <div className="bg-navy-50 p-3 rounded-full mr-4">
                    <FaBullseye className="text-2xl text-navy-500" />
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-8 mb-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      <h3 className="font-bold text-xl text-navy-500 mb-3">Quality of Service (QoS)</h3>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      <h3 className="font-bold text-xl text-navy-500 mb-3">Bandwidth Allocation</h3>
                      <p className="text-gray-600 mb-4">
              ...
              <div className="mb-16">
                <div className="flex items-center mb-6">
                  <div className="bg-navy-50 p-3 rounded-full mr-4">
                    <FaRegLightbulb className="text-2xl text-navy-500" />
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-8 mb-8">
                  ...
                  <div className="space-y-5">
                    <div className="flex">
                      <div className="bg-green-100 text-green-700 font-bold rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1 mr-4">1</div>
                      <div>
                    ...
                    <div className="flex">
                      <div className="bg-green-100 text-green-700 font-bold rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1 mr-4">2</div>
                      <div>
                    ...
                    <div className="flex">
                      <div className="bg-green-100 text-green-700 font-bold rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1 mr-4">3</div>
                      <div>
                    ...
                    <div className="flex">
                      <div className="bg-green-100 text-green-700 font-bold rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1 mr-4">4</div>
                      <div>
              ...
              <div className="mb-16">
                <div className="flex items-center mb-6">
                  <div className="bg-navy-50 p-3 rounded-full mr-4">
                    <FaHeadset className="text-2xl text-navy-500" />
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-8 mb-8">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                    <h3 className="font-bold text-xl text-navy-500 mb-3">IP Phone Selection</h3>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-sm">
                    <h3 className="font-bold text-xl text-navy-500 mb-3">Headset Recommendations</h3>
              ...
              <div className="mb-16">
                <div className="flex items-center mb-6">
                  <div className="bg-navy-50 p-3 rounded-full mr-4">
                    <FaShieldAlt className="text-2xl text-navy-500" />
                  </div>
                ...
                <div className="bg-gray-50 rounded-xl p-8 mb-8">
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      <h3 className="font-bold text-xl text-navy-500 mb-3">Encryption Implementation</h3>
                      <p className="text-gray-600 mb-4">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      <h3 className="font-bold text-xl text-navy-500 mb-3">Access Controls</h3>
                      <p className="text-gray-600 mb-4">
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm">
                      <h3 className="font-bold text-xl text-navy-500 mb-3">Network Segregation</h3>
                      <p className="text-gray-600 mb-4">
                ...
                <div className="bg-green-50 p-6 rounded-lg">
                  <div className="flex items-center">
                    <FaPhoneAlt className="text-green-700 mr-3" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <a href="#" className="block bg-white border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                    <div className="flex items-center mb-4">
                      <FaFileDownload className="text-2xl text-navy-500 mr-3" />
                    ...
                    <span className="text-navy-500 font-medium">Download PDF</span>
                  </a>
