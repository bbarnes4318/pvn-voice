  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-navy-50 to-navy-100">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-navy-600 via-navy-500 to-navy-500 text-white py-20 overflow-hidden">
          ...
          <div className="relative z-10 container-custom text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-navy-50 mb-8 font-medium">All your business communications—voice, video, chat, and collaboration—in one secure, cloud-based platform.</p>
            <a 
              href="tel:+19045128487" 
              className="inline-flex items-center px-8 py-4 rounded-xl bg-green-700 hover:bg-green-800 text-lg font-semibold shadow-lg transition space-x-3"
            >
        ...
        <section className="py-20 bg-gradient-to-br from-white to-navy-50">
          <div className="container-custom">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-navy-600">Key Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaVideo className="text-4xl text-navy-500 mb-4" aria-label="HD Video Conferencing" />
              ...
              <div className="bg-gradient-to-br from-purple-100 to-purple-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaComments className="text-4xl text-navy-500 mb-4" aria-label="Team Messaging" />
              ...
              <div className="bg-gradient-to-br from-green-100 to-green-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaUsers className="text-4xl text-navy-500 mb-4" aria-label="Presence Management" />
              ...
              <div className="bg-gradient-to-br from-yellow-100 to-yellow-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaDesktop className="text-4xl text-navy-500 mb-4" aria-label="Desktop & Mobile Apps" />
              ...
              <div className="bg-gradient-to-br from-pink-100 to-pink-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaRobot className="text-4xl text-navy-500 mb-4" aria-label="AI Productivity Tools" />
              ...
              <div className="bg-gradient-to-br from-gray-100 to-gray-50 p-8 rounded-2xl shadow hover:shadow-xl transition">
                <FaShieldAlt className="text-4xl text-navy-500 mb-4" aria-label="Enterprise Security" />
        ...
        <section className="py-20 bg-gradient-to-br from-navy-50 to-navy-100">
          <div className="container-custom grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold mb-6 text-navy-600">Why Choose PVN Voice?</h2>
        ...
        <section className="py-20 bg-gradient-to-br from-white to-navy-50">
          <div className="container-custom">
            <h2 className="text-3xl font-bold text-center mb-12 text-navy-600">Perfect for Every Work Environment</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              <div className="bg-navy-50 p-8 rounded-2xl shadow">
                <FaGlobe className="text-3xl text-navy-500 mb-4" aria-label="Remote Teams" />
              ...
              <div className="bg-green-50 p-8 rounded-2xl shadow">
                <FaDesktop className="text-3xl text-navy-500 mb-4" aria-label="Hybrid Workforces" />
              ...
              <div className="bg-purple-50 p-8 rounded-2xl shadow">
                <FaUsers className="text-3xl text-navy-500 mb-4" aria-label="Customer Service Teams" />
        ...
        <section className="py-20 bg-gradient-to-br from-navy-500 to-navy-500 text-white">
          <div className="container-custom">
        ...
        <section className="py-20 bg-gradient-to-br from-white to-navy-50">
          <div className="container-custom text-center">
            <h2 className="text-3xl font-bold mb-6 text-navy-600">Simple, Transparent Pricing</h2>
            <div className="flex flex-col md:flex-row justify-center gap-8 mb-8">
              <div className="bg-gradient-to-br from-navy-100 to-navy-50 p-8 rounded-2xl shadow w-full max-w-xs mx-auto flex flex-col items-center">
                <FaDollarSign className="text-3xl text-navy-500 mb-2" />
                ...
                <a href="tel:+19045128487" className="inline-flex items-center px-6 py-3 rounded-full bg-green-700 hover:bg-green-800 text-white font-semibold shadow transition space-x-2">
                  <FaPhoneAlt />
                  <span>Call (904) 512-8487</span>
                </a>
              </div>
            </div>
            <div className="text-lg text-navy-600 mb-2">Or contact us for a free, no-obligation consultation.</div>
            <a href="mailto:info@pvndialer.com" className="inline-flex items-center px-6 py-3 rounded-xl bg-navy-500 hover:bg-navy-600 text-white font-semibold shadow transition space-x-2">
              <FaEnvelope />
              <span>Email Us</span>
            </a>
          </div>
